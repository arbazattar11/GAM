...
$GAMTOOLS create-matrix -i $FILTERED_DIR -o $CONTACT_MATRIX_DIR/matrix.txt

# Step 6: Normalization
mkdir -p $NORMALIZED_MATRIX_DIR
$GAMTOOLS normalize-matrix -i $CONTACT_MATRIX_DIR/matrix.txt -o $NORMALIZED_MATRIX_DIR/normalized_matrix.txt

# Step 7: Visualization
mkdir -p $VISUALIZATION_DIR
$GAMTOOLS visualize-matrix -i $NORMALIZED_MATRIX_DIR/normalized_matrix.txt -o $VISUALIZATION_DIR/visualization.png

# Step 8: Interaction Analysis
$GAMTOOLS find-interactions -i $NORMALIZED_MATRIX_DIR/normalized_matrix.txt -o $VISUALIZATION_DIR/interactions.txt

echo "GAM analysis pipeline complete!"
